...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13526 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13526 = (function (val,box,meta13527){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13526.cljs$lang$type = true;
cljs.core.async.impl.channels.t13526.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13526";
cljs.core.async.impl.channels.t13526.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t13526");
});
cljs.core.async.impl.channels.t13526.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13526.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13528){var self__ = this;
var _13528__$1 = this;return self__.meta13527;
});
cljs.core.async.impl.channels.t13526.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13528,meta13527__$1){var self__ = this;
var _13528__$1 = this;return (new cljs.core.async.impl.channels.t13526(self__.val,self__.box,meta13527__$1));
});
cljs.core.async.impl.channels.__GT_t13526 = (function __GT_t13526(val__$1,box__$1,meta13527){return (new cljs.core.async.impl.channels.t13526(val__$1,box__$1,meta13527));
});
}
return (new cljs.core.async.impl.channels.t13526(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13529 = self__.takes.pop();if((taker_13529 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13529))
{var take_cb_13530 = cljs.core.async.impl.protocols.commit.call(null,taker_13529);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13530,taker_13529,this$__$1){
return (function (){return take_cb_13530.call(null,null);
});})(take_cb_13530,taker_13529,this$__$1))
);
} else
{}
{
