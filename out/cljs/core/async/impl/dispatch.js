...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13520 = (0);while(true){
var m_13521 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13521 == null))
{} else
{m_13521.call(null);
if((count_13520 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13522 = (count_13520 + (1));
count_13520 = G__13522;
continue;
}
} else
{}
