...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13427 = (0);while(true){
if((i_13427 < arr.length))
{(arr[i_13427] = null);
{
...
{var i_13434 = (self__.level + (1));while(true){
if((i_13434 <= (new_level + (1))))
{(update[i_13434] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13436 = (0);while(true){
if((i_13436 <= self__.level))
{var links_13437 = (update[i_13436]).forward;if(((links_13437[i_13436]) === x__$1))
{(links_13437[i_13436] = (x__$1.forward[i_13436]));
{
var G__13438 = (i_13436 + (1));
i_13436 = G__13438;
continue;
}
} else
{{
var G__13439 = (i_13436 + (1));
i_13436 = G__13439;
continue;
}
}
